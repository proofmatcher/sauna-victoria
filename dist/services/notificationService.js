 ...
 */
export const notifyStaffAboutTrip = async (tripId) => {
    try {
 ...
 */
export const notifyCustomerBookingConfirmed = async (bookingId) => {
    try {
        ...
        const user = booking.user; // Can be null for guest bookings
 ...
 */
export const notifyCustomerMobileSaunaBookingConfirmed = async (bookingId) => {
    try {
        const booking = await Booking.findById(bookingId)
            .populate("user")
            .populate("vessel");
 ...
 */
export const sendTripReminders = async (tripId) => {
    try {
        const trip = await Trip.findById(tripId)
            .populate("vessel")
            .populate("assignedStaff");
