 ...
 */
export const getMobileSaunaBookings = async (_req, res) => {
    try {
 ...
 */
export const updateMobileSaunaBooking = async (req, res) => {
    try {
        const { id } = req.params;
        ...
        // Update the booking
        const updatedBooking = await Booking.findByIdAndUpdate(id, updateData, { new: true, runValidators: true }).populate('vessel', 'name type');
        if (!updatedBooking) {
        ...
        res.json({
            ...
            booking: {
                ...
                vesselName: updatedBooking.vessel?.name,
 ...
 */
export const deleteMobileSaunaBooking = async (req, res) => {
    try {
        const { id } = req.params;
        // Validate the booking ID
        if (!mongoose.Types.ObjectId.isValid(id)) {
 ...
 */
export const getMobileSaunaBookingById = async (req, res) => {
    try {
        const { id } = req.params;
        // Validate the booking ID
        if (!mongoose.Types.ObjectId.isValid(id)) {
...
//# sourceMappingURL=adminMobileSaunaController.js.map