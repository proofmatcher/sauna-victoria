...
servicePostSchema.pre<IServicePost>("save", async function (next) {
  if (this.isModified("title")) {
    ...
    const ServicePostModel = mongoose.model<IServicePost>("ServicePost");
...
export default mongoose.model<IServicePost>("ServicePost", servicePostSchema);
