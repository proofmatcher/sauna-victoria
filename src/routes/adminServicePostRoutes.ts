...
import {
  ...
  togglePublished,
  getPostStats,
} from "../controllers/adminServicePostController.js";

const router = express.Router();

// All routes require admin authentication
router.post("/", protect, authorize("admin"), createPost);                      // Create new post
...
router.put("/:id", protect, authorize("admin"), updatePost);                    // Update post
