...
const passwordResetAttempts: RateLimitStore = {};
const registrationAttempts: RateLimitStore = {};
...
const createRateLimiter = (store: RateLimitStore, maxAttempts: number, windowMs: number, errorMessage: string) => {
