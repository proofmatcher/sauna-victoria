...
export const updateVessel = async (req: Request, res: Response) => {
  try {
    ...
    if (isCapacityChanged) {
      ...
      const result = await handleVesselCapacityChange(vesselId as string, updates.capacity);
...
export const updateVesselCapacity = async (req: Request, res: Response) => {
  try {
    ...
    const { handleVesselCapacityChange } = await import("../utils/capacityUtils.js");
    const result = await handleVesselCapacityChange(vesselId as string, capacity);
