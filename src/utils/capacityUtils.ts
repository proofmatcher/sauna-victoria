 ...
 */
export const handleVesselCapacityChange = async (
  vesselId: string, 
  newCapacity: number
  ...
  try {
    ...
    for (const trip of trips) {
      try {
        ...
        await trip.save();
        updatedTrips.push((trip._id as any).toString());
 ...
 */
export const getTripBookingStats = (trip: any) => {
